<template>
  <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 add-flow-card-wrap">
...
export default {
  ...
  methods: {
    ...
    addFlowHeight() {
      ...
      if (addFlowCard && flowCard) {
        addFlowCard.style.height = flowCard.clientHeight + 'px'
      }
    }
  },
  mounted() {
...
.add-flow-card {
  ...
  box-shadow: 0px 5px 0px $gray-08;
  cursor: pointer;
  transition: 0.2s;
  position: relative;
  display: flex;
